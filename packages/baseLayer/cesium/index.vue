...
const props = withDefaults(defineProps<IonLayerProps>(), {
    show: true,
...
const initComponent = () => {
    ...
    layer = new mars3d.layer.IonLayer(filter(props) as IonLayerProps)
