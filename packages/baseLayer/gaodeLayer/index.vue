...
const props = withDefaults(defineProps<GaodeLayerProps>(), {
    show: true,
...
const initComponent = () => {
    ...
    layer = new mars3d.layer.GaodeLayer(filter(props) as object)
