...
import type { BaseClass, ChinaCRS, layer, Map } from 'mars3d'
import { filter } from '../../utils/propsUtil'
import { CRS, Cesium } from 'mars3d'
...
interface BingLayerProps {
    ...
    layer?: Cesium.BingMapsStyle | string
    minimumLevel?: number
    maximumLevel?: number
...
const props = withDefaults(defineProps<BingLayerProps>(), {
    show: true,
...
const initComponent = () => {
    ...
    layer = new mars3d.layer.BingLayer(filter(props) as object)
